...
class TestEpargne(unittest.TestCase):
    ...
    def test_initialisation(self):
        ...
        self.assertEqual(self.epargne_complete.fiscalite, "Exonéré")
        ...
        self.assertEqual(self.epargne_sans_max.fiscalite, "Imposable")
    ...
    def test_str(self):
        ...
        expected_str_complete = "Produit d'épargne 'Livret A' avec un taux d'intérêt de 0.03, une fiscalité de Exonéré, une durée minimale de 0 ans, avec un versement maximum de 22950 €."
        self.assertEqual(str(self.epargne_complete), expected_str_complete)
        
        # Test sans versement maximum
        expected_str_sans_max = "Produit d'épargne 'PEL' avec un taux d'intérêt de 0.02, une fiscalité de Imposable, une durée minimale de 4 ans, sans limite de versement."
    ...
    def test_repr(self):
        ...
        self.assertIn("fiscalite=Exonéré", repr_complete)
        ...
        self.assertIn("fiscalite=Imposable", repr_sans_max)
